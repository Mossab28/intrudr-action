...
interface CommentInput { internal: Finding[]; external: Finding[]; externalRan: boolean; externalFailed?: boolean; reportUrl: string | null; riskScore: number | null; reconNote?: string | null }
